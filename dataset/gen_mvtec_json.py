...
class MVTecAD_Loader(object):
    ...
    def __init__(self, root="./dataset/data/MVTecAD"):
        self.root = root
    ...
    def run(self):
        ...
        for cls_name in self.CLSNAMES:
            ...
            for phase in ["train", "test"]:
                ...
                for specie in species:  # different types of anomalies
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="./dataset/data/MVTecAD",
        help="Path to the dataset directory."
    )
    args = parser.parse_args()
    runner = MVTecAD_Loader(root=args.data_path)
    runner.run()